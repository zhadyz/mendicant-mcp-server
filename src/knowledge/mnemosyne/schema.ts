...
export interface AgentExecution {
  ...
  name: string;  // Unique execution ID
  agent_id: AgentId;
  objective: string;
  success: boolean;
  tokens_used?: number;
  ...
  timestamp: number;
  context_signature?: string;  // Hash of execution context
}
...
export interface ObjectivePattern {
  ...
  objective_type: string;  // "implement", "fix", "test", "deploy"
...
export interface ContextSignature {
  ...
  name: string;  // Hash of context
  project_type?: string;
  has_tests: boolean;
  other_factors: string[];  // Other relevant context factors
}
 ...
 */
export function agentProfileToEntity(profile: AgentProfile): MnemosyneEntity {
  return {
    name: profile.name,
 ...
 */
export function agentExecutionToEntity(execution: AgentExecution): MnemosyneEntity {
  const observations = [
 ...
 */
export function objectivePatternToEntity(pattern: ObjectivePattern): MnemosyneEntity {
  return {
    name: pattern.name,
 ...
 */
export function contextSignatureToEntity(signature: ContextSignature): MnemosyneEntity {
  const observations = [
 ...
 */
export function createContextSignature(
  objective: string,
  context?: ProjectContext
): ContextSignature {
 ...
 */
export function createExecutedRelation(
  agent_id: AgentId,
 ...
 */
export function createMatchesContextRelation(
  execution_name: string,
  context_hash: string
): MnemosyneRelation {
  return {
 ...
 */
export function createSimilarToRelation(
  pattern_a: string,
  pattern_b: string
): MnemosyneRelation {
  return {
 ...
 */
export function createPrecededByRelation(
  execution_a: string,
  execution_b: string
): MnemosyneRelation {
  return {
