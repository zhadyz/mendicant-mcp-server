...
import type { ExecutionRecord } from '../../knowledge/mnemosyne/client.js';
...
describe('MnemosyneClient', () => {
  ...
  let mockTools: ReturnType<typeof createMockMCPTools>;

  beforeEach(() => {
    mockTools = createMockMCPTools();
    client = new MnemosyneClient(mockTools as any);
    jest.clearAllMocks();
  });
  ...
  describe('Connection Status', () => {
    ...
    test('should allow setting MCP tools after construction', () => {
      ...
      newClient.setMCPTools(mockTools as any);
