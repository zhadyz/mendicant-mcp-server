 ...
 */
import { parseAgentFromDescription, categorizeAgent } from './agent_capability_parser.js';
/**
...
export class MCPAgentDiscovery {
    ...
    constructor() {
        ...
        this.discoverAvailableAgents().catch(err => console.error('[MCPAgentDiscovery] Failed to auto-discover:', err));
    }
    /**
     ...
     */
    needsRefresh(intervalMs = 5 * 60 * 1000) {
...
//# sourceMappingURL=mcp_agent_discovery.js.map