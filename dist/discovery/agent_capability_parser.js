 ...
 */
export function parseAgentFromDescription(raw) {
 ...
 */
export function categorizeAgent(agentId, description) {
 ...
 */
function extractSpecialization(agentId, description, category) {
 ...
 * Infer capabilities from description and tools
 */
function inferCapabilities(description, tools) {
 ...
 * Extract typical use cases from description
 */
function extractUseCases(description, category) {
    const descLower = description.toLowerCase();
    const useCases = [];
 ...
 * Estimate token usage based on category
 */
function estimateTokenUsage(category) {
    const estimates = {
...
//# sourceMappingURL=agent_capability_parser.js.map