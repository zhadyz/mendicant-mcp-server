 ...
 */
export function enforceConstraints(agents, estimatedTokens, constraints) {
    if (!constraints) {
 ...
 */
function priorityTrim(agents, maxAgents) {
 ...
 */
function budgetTrim(agents, maxTokens, currentEstimate) {
 ...
 */
export function validatePlan(agents, estimatedTokens, constraints) {
    const warnings = [];
    if (!constraints) {
...
//# sourceMappingURL=constraint_enforcer.js.map