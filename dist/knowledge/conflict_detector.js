 ...
 */
export function detectPlanConflicts(agents) {
    const conflicts = [];
    const warnings = [];
 ...
 */
export function detectExecutionConflicts(results) {
    const conflicts = [];
 ...
 */
function detectCircularDependencies(agents) {
    const cycles = [];
 ...
 */
function detectContradictoryAgents(agents) {
    const conflicts = [];
 ...
 */
function detectExecutionOrderViolations(agents) {
    const warnings = [];
 ...
 */
function detectResourceContention(agents) {
    const warnings = [];
    // Agents that commonly modify the same resources
    const contentionGroups = {
 ...
 */
function detectOutputConflicts(results) {
    const conflicts = [];
 ...
 */
function detectTestingConflicts(results) {
    const conflicts = [];
    ...
    if (testing && implementation && testing.success) {
        ...
        if (testOutput.includes('vulnerability') ||
 ...
 */
function detectArchitectureConflicts(results) {
    const conflicts = [];
 ...
 */
function detectSecurityConflicts(results) {
    const conflicts = [];
    ...
    if (security && implementation && security.success) {
        ...
        if (secOutput.includes('vulnerability') ||
 ...
 */
function calculateDependencyDepth(agents) {
    ...
    function getDepth(agentId, visited = new Set()) {
 ...
 */
function detectContradictoryOutputs(output1, output2) {
...
//# sourceMappingURL=conflict_detector.js.map