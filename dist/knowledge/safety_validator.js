 ...
 */
export function validateSafety(objective) {
    const lower = objective.toLowerCase().trim();
    const detected_threats = [];
 ...
 */
function generateSafetyRecommendations(threats) {
 ...
 */
export function shouldBlockExecution(safetyAnalysis) {
...
//# sourceMappingURL=safety_validator.js.map